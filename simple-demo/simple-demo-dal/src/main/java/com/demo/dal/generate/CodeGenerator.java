...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        String simpleDemoPath = System.getProperty("user.dir") + "/simple-demo-dal";
        gc.setOutputDir(simpleDemoPath + "/src/main/java");
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return simpleDemoPath + "/src/main/resources/mapper/"
